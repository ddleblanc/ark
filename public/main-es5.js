...
var PostDetailReviewComponent = /** @class */ (function () {
    function PostDetailReviewComponent() {
    }
    PostDetailReviewComponent.prototype.ngOnInit = function () {
    };
    ...
    return PostDetailReviewComponent;
}());
...
var PostDetailSummaryComponent = /** @class */ (function () {
    function PostDetailSummaryComponent() {
    }
    PostDetailSummaryComponent.prototype.ngOnInit = function () {
    };
    ...
    return PostDetailSummaryComponent;
}());
...
var PostDetailComponent = /** @class */ (function () {
    function PostDetailComponent(router, route, postService, _bottomSheet) {
        this.router = router;
        this.route = route;
        this.postService = postService;
        this._bottomSheet = _bottomSheet;
    ...
    PostDetailComponent.prototype.swipe = function (e, when) {
        var coord = [e.changedTouches[0].clientX, e.changedTouches[0].clientY];
        var time = new Date().getTime();
        if (when === 'start') {
            this.swipeCoord = coord;
    ...
    PostDetailComponent.prototype.navigateTo = function (_a) {
        var index = _a.index;
        var route;
        switch (index) {
            case 0:
    ...
    PostDetailComponent.prototype.switchPlayback = function (i) {
        var videos = document.querySelectorAll(".swiper-slide");
        console.log(i);
        var previousVideo = videos[this.prevIndex];
        previousVideo.pause();
